  ...
  return (
    <>
      ...
      <div className="px-4 mb-4 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2">
        ...
        <a href="single-note.html" className="bg-green-200 p-3 rounded shadow">
          <div className="flex justify-between items-center mb-1">
            <h1 className="font-medium text-lg">Shopping List</h1>
          </div>
          <p className="text-gray-600 text-sm">
            Okay, so far this is what we need: 12 eggs...
          </p>
        </a>
        <a href="single-note.html" className="bg-red-200 p-3 rounded shadow">
          <div className="flex justify-between items-center mb-1">
            <h1 className="font-medium text-lg">Trip to San fran</h1>
          </div>
          <p className="text-gray-600 text-sm">
        ...
        <a href="single-note.html" className="bg-yellow-200 p-3 rounded shadow">
          <div className="flex justify-between items-center mb-1">
            <h1 className="font-medium text-lg">Trip to San fran</h1>
          </div>
          <p className="text-gray-600 text-sm">
